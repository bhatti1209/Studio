...
namespace E_HELP_DESK1.UI {
    ...
    public class Complaint : ReportClass {
    ...
    public class CachedComplaint : Component, ICachedReport {
        
        public CachedComplaint() {
        }
