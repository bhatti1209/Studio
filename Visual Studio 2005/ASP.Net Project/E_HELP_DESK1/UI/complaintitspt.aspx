...
<%@ Page language="c#" Inherits="E_HELP_DESK1.UI.complaintitspt1" CodeFile="complaintitspt.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>complaintitspt</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<CR:CrystalReportViewer id="CrystalReportViewer1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px"
				runat="server" Width="256px" Height="64px" BestFitPage="False"></CR:CrystalReportViewer>
		</form>
	</body>
</HTML>
