<%@ Page language="c#" Inherits="E_HELP_DESK1.UI.individualcomplain" CodeFile="individualcomplain.aspx.cs" %>
...
<HTML>
	<HEAD>
		<title>individualcomplain</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<CR:CrystalReportViewer id="CrystalReportViewer1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px"
				runat="server" Width="350px" Height="50px" DisplayGroupTree="False"></CR:CrystalReportViewer>
		</form>
	</body>
</HTML>
