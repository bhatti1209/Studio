<%@ Page Language="C#" MasterPageFile="~/UI/AdminFolder/Logo.master" AutoEventWireup="true" CodeFile="CallStatus.aspx.cs" Inherits="UI_AdminFolder_Default2" Title="Call Status" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    &nbsp; &nbsp; &nbsp;&nbsp;
    <asp:TextBox ID="probdescbox" runat="server" Height="86px" Style="left: 225px; position: absolute;
        top: 917px" TextMode="MultiLine" Width="715px" Visible="False"></asp:TextBox>
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
        AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None"
        BorderWidth="1px" CellPadding="3" DataSourceID="noneselected" GridLines="Vertical"
        Height="1px" OnSelectedIndexChanged="LinkButton1_Click" SelectedIndex="0" Style="left: 229px;
        position: absolute; top: 528px" Visible="False" Width="653px" PageSize="6">
    ...
    <asp:SqlDataSource ID="noneselected" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString3.ProviderName %>" SelectCommand="SELECT TCK_ID, CAT, SUBCAT, ASSGN_TO, STATUS, SITE_ID, HLPDEK, LOG_DATE, PROB_SUB FROM NHD_CMPTBL">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="bothselected" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString3.ProviderName %>" SelectCommand="SELECT TCK_ID, CAT, SUBCAT, ASSGN_TO, STATUS, SITE_ID, HLPDEK, LOG_DATE, PROB_SUB FROM NHD_CMPTBL WHERE  (STATUS = :status) AND (HLPDEK = :helpdesk)">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="callstatusselected" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString3.ProviderName %>" SelectCommand="SELECT TCK_ID, CAT, SUBCAT, ASSGN_TO,STATUS, SITE_ID, HLPDEK, LOG_DATE, PROB_SUB FROM NHD_CMPTBL WHERE (STATUS = :status)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList2" Name="status" PropertyName="Text" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="helpdeskselected" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString3.ProviderName %>" SelectCommand="SELECT TCK_ID, CAT, SUBCAT, ASSGN_TO,STATUS, SITE_ID, HLPDEK, LOG_DATE, PROB_SUB FROM NHD_CMPTBL WHERE (HLPDEK = :helpdesk)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList1" Name="helpdesk" PropertyName="Text" />
        </SelectParameters>
    </asp:SqlDataSource>
