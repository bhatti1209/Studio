<%@ Page Language="C#" MasterPageFile="~/UI/AdminFolder/Logo.master" AutoEventWireup="true" CodeFile="HelpDeskCalls.aspx.cs" Inherits="UI_AdminFolder_Default" Title="HelpDesk Calls" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />
    <br /><asp:TextBox ID="TextBox1" runat="server" Font-Bold="True" Font-Names="Perpetua Titling MT"
    ...
    <asp:DropDownList ID="DropDownList4" runat="server" Style="left: 743px; position: absolute;
        top: 415px" DataSourceID="SqlDataSourceSiteID" DataTextField="SITEID" DataValueField="SITEID" TabIndex="4" Visible="False">
    </asp:DropDownList><asp:DropDownList ID="DropDownList6" runat="server" Style="left: 742px; position: absolute;
        top: 415px" TabIndex="4" Width="90px">
    </asp:DropDownList>
    &nbsp;
    &nbsp;&nbsp;
    ...
    <br />
    <br />
    <asp:TextBox ID="probdescbox" runat="server" Height="108px" Style="left: 168px; position: absolute;
        top: 894px" Visible="False" Width="802px"></asp:TextBox>
    <br />
    <br />
    <br />
    <br />
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Problem Subject" ShowHeader="False">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Assign To">
                <ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>"
                        ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>" SelectCommand="SELECT USER_NAME FROM NHD_USERDATA WHERE (USER_LOGIN_TYPE = 'ITEng')">
                    </asp:SqlDataSource>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    </asp:SqlDataSource><asp:SqlDataSource ID="categoryselected2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>"
