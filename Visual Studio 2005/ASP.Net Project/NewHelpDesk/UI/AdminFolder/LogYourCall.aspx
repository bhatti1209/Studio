<%@ Page Language="C#" MasterPageFile="~/UI/AdminFolder/Logo.master" AutoEventWireup="true" CodeFile="LogYourCall.aspx.cs" Inherits="UI_AdminFolder_Default2" Title="Log Your Calls" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DropDownList ID="usernamebox" runat="server" DataSourceID="ObjectDataSource1"
        DataTextField="USER_NAME" DataValueField="USER_NAME" Enabled="False" Style="left: 800px;
        position: absolute; top: 362px" Width="154px">
    </asp:DropDownList>
    <br />
    &nbsp;
    ...
    <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" Font-Bold="True"
        ForeColor="White" Height="1px" Style="left: 667px;
        position: absolute; top: 325px" Text="Check This If Filling For Another User"
        Width="285px" />
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
    ...
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp;&nbsp;<asp:DropDownList ID="DropDownList6" runat="server" Style="left: 557px; position: absolute;
        top: 324px;" TabIndex="2" Width="83px">
    </asp:DropDownList>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <asp:DropDownList ID="DropDownList4" runat="server" Style="left: 554px; position: absolute;
        top: 324px;" TabIndex="2" Visible="False" Width="89px" DataSourceID="SqlDataSourceSiteID" DataTextField="SITEID" DataValueField="SITEID">
    </asp:DropDownList>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    ...
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
    <asp:Label ID="Label13" runat="server" Font-Bold="True" ForeColor="White" Style="left: 670px;
        position: absolute; top: 365px" Text="Enter User Name :" Width="142px"></asp:Label>
    <br />
    ...
    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
    &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;<strong style="color:Red; position:absolute; top:647px; left:324px">*</strong>&nbsp; &nbsp; &nbsp;
    ...
    <asp:Label ID="Label6" runat="server" Font-Bold="True" ForeColor="White" Text="Problem Description"
        Width="72px" style="left: 241px; position: absolute; top: 641px"></asp:Label><strong style="color:Red; position:absolute; top:503px; left:315px">*</strong>&nbsp;<br />
    &nbsp; &nbsp;<br />
    &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;<br />
    <br />
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    ...
    <asp:TextBox ID="TextBox3" runat="server" ReadOnly="True" Style="position: absolute; left: 351px; top: 805px;"
        Width="288px">*Max Attachment Size Can Be 2MB (JPEG Only)</asp:TextBox>
    &nbsp;&nbsp;<br />
    <asp:Label ID="Label16" runat="server" Font-Bold="True" ForeColor="Red" Style="left: 351px;
        position: absolute; top: 847px" Text="Please Select Category !!" Visible="False"
        Width="175px"></asp:Label>
    <br />
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp;&nbsp;
    <asp:Label ID="Label9" runat="server" Font-Bold="True" ForeColor="Red" Style="position: absolute; left: 634px; top: 900px;"
        Text="Please Enter Problem Subject !!" Visible="False" Width="215px"></asp:Label>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <br />
    <br />
