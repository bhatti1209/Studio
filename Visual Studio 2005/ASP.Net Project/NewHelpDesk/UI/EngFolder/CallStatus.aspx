<%@ Page Language="C#" MasterPageFile="~/UI/EngFolder/Logo.master" AutoEventWireup="true" CodeFile="CallStatus.aspx.cs" Inherits="UI_AdminFolder_Default2" Title="Call Status" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />
    <br />
    <asp:TextBox ID="TextBox1" runat="server" Font-Bold="True" Font-Names="Perpetua Titling MT" Font-Size="Medium" ForeColor="Red" ReadOnly="True" Width="791px">   CALL STATUS</asp:TextBox><br />
    <br />
    ...
    <asp:Button ID="ResetButton" runat="server" OnClick="ResetButton_Click" Style="left: 607px;
    ...
    <br />
    &nbsp; &nbsp; &nbsp;&nbsp;
    <asp:TextBox ID="probdescbox" runat="server" Height="86px" Style="left: 186px; position: absolute;
        top: 938px" TextMode="MultiLine" Width="759px" Visible="False"></asp:TextBox>
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
        AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None"
        BorderWidth="1px" CellPadding="3" DataSourceID="noneselected" GridLines="Vertical"
        Height="1px" OnSelectedIndexChanged="LinkButton1_Click" SelectedIndex="0" Style="left: 184px;
        position: absolute; top: 528px" Visible="False" Width="767px" PageSize="6">
    ...
    <asp:SqlDataSource ID="noneselected" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString3.ProviderName %>" SelectCommand="SELECT TCK_ID, CAT, SUBCAT, ASSGN_TO, STATUS, SITE_ID, HLPDEK, LOG_DATE, PROB_SUB FROM NHD_CMPTBL WHERE ASSGN_TO = :assign">
        <SelectParameters>
            <asp:ControlParameter ControlID="Hidden1" Name="assign" PropertyName="Value" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="bothselected" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString3.ProviderName %>" SelectCommand="SELECT TCK_ID, CAT, SUBCAT, ASSGN_TO, STATUS, SITE_ID, HLPDEK, LOG_DATE, PROB_SUB FROM NHD_CMPTBL WHERE  (STATUS = :status) AND (HLPDEK = :helpdesk) AND (ASSGN_TO = :assign)">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="callstatusselected" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString3.ProviderName %>" SelectCommand="SELECT TCK_ID, CAT, SUBCAT, ASSGN_TO,STATUS, SITE_ID, HLPDEK, LOG_DATE, PROB_SUB FROM NHD_CMPTBL WHERE (STATUS = :status) AND (ASSGN_TO = :assign)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList2" Name="status" PropertyName="Text" />
            <asp:ControlParameter ControlID="Hidden1" Name="assign" PropertyName="Value" />
        </SelectParameters>
    ...
    <asp:SqlDataSource ID="helpdeskselected" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString3.ProviderName %>" SelectCommand="SELECT TCK_ID, CAT, SUBCAT, ASSGN_TO,STATUS, SITE_ID, HLPDEK, LOG_DATE, PROB_SUB FROM NHD_CMPTBL WHERE (HLPDEK = :helpdesk) AND (ASSGN_TO = :assign)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList1" Name="helpdesk" PropertyName="Text" />
            <asp:ControlParameter ControlID="Hidden1" Name="assign" PropertyName="Value" />
        </SelectParameters>
