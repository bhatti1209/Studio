<%@ Page Language="C#" MasterPageFile="~/UI/EngFolder/Logo.master" AutoEventWireup="true" CodeFile="EmailIDCreation.aspx.cs" Inherits="UI_AdminFolder_Default" Title="Email Id Creation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    </asp:DropDownList><asp:DropDownList ID="DropDownList4" runat="server" Style="left: 720px; position: absolute;
    ...
    <br />
    <br />
    <asp:Label ID="Label15" runat="server" Font-Bold="True" ForeColor="White" Style="left: 288px;
        position: absolute; top: 556px" Text="Upload File :"></asp:Label>
