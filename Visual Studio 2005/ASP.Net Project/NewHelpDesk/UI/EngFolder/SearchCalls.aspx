<%@ Page Language="C#" MasterPageFile="~/UI/EngFolder/Logo.master" AutoEventWireup="true" CodeFile="SearchCalls.aspx.cs" Inherits="UI_AdminFolder_Default" Title="Search Calls" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="White" Style="left: 403px;
        position: absolute; top: 347px" Text="Reference ID :" Width="105px"></asp:Label>
    <br />
    <br />
    ...
    <br />
    <br />
    <asp:TextBox ID="probdescbox" runat="server" Height="86px" Style="left: 214px; position: absolute;
        top: 632px" TextMode="MultiLine" Visible="False" Width="727px"></asp:TextBox>
    <br />
    <br />
    <br />
    <br />
