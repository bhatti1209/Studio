<%@ Page Language="C#" MasterPageFile="~/UI/EngFolder/Logo.master" AutoEventWireup="true" CodeFile="SiteDetails.aspx.cs" Inherits="UI_UserFolder_Default" Title="siteregistration" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:TextBox ID="TextBox1" runat="server" Font-Bold="True" Font-Names="Perpetua Titling MT"
        ...
        Width="794px">    SITE Details</asp:TextBox><br />
    <br />
    <br />
    <br />
    <br />
    <br />
    <asp:FormView ID="FormView1" runat="server" AllowPaging="True" CellPadding="4" DataSourceID="SqlDataSource1" Height="260px" Width="693px" style="left: 267px; position: absolute; top: 352px" ForeColor="#333333">
        ...
        <ItemTemplate>
            ...
            <asp:Label ID="Label5" runat="server" Style="left: 282px; position: absolute; top: 27px"
                Text="Site Id :"></asp:Label>
            <asp:Label ID="Label9" runat="server" Style="left: 557px; position: absolute; top: 81px"
            ...
            <asp:Label ID="Label11" runat="server" Style="left: 555px; position: absolute; top: 203px"
                Text="Submask  :"></asp:Label>
            <asp:Label ID="Label6" runat="server" Style="left: 300px; position: absolute; top: 81px"
                Text="Site Location :"></asp:Label>
            <br />
            &nbsp;
            <asp:Label ID="SITENAMELabel" runat="server" Style="left: 332px; position: absolute;
                top: 27px" Text='<%# Bind("SITENAME") %>' Width="183px"></asp:Label>
            <br />
            &nbsp;
            ...
            <asp:Label ID="Label8" runat="server" Style="left: 294px; position: absolute; top: 203px"
                Text="Gateway IP  :"></asp:Label>
            <asp:Label ID="Label7" runat="server" Style="left: 278px; position: absolute; top: 138px"
                Text="Contact Mail Id  :"></asp:Label>
            &nbsp;<br />
            &nbsp;
            <asp:Label ID="TYPEOFOFFICELabel" runat="server" Style="left: 628px; position: absolute;
            ...
            <br />
            &nbsp;
            <asp:Label ID="CONTACTEMAILIDLabel" runat="server" Style="left: 382px; position: absolute;
            ...
            <br />
            &nbsp;
            <asp:Label ID="GATEWAYIPLabel" runat="server" Style="left: 372px; position: absolute;
                top: 203px" Text='<%# Bind("GATEWAYIP") %>' Width="138px"></asp:Label>
            <br />
            &nbsp;
            <asp:Label ID="SUBMASKLabel" runat="server" Style="left: 625px; position: absolute;
