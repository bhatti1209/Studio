<%@ Page Language="C#" MasterPageFile="~/UI/UserFolder/Logo.master" AutoEventWireup="true" CodeFile="EmailIDCreation.aspx.cs" Inherits="UI_AdminFolder_Default" Title="Email Id Creation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:TextBox ID="Datetextbox" runat="server" ReadOnly="True" Style="left: 401px;
        position: absolute; top: 356px" Width="117px" TabIndex="1"></asp:TextBox>
    <br />
    <br />
    ...
    </asp:DropDownList><asp:DropDownList ID="DropDownList4" runat="server" Style="left: 721px; position: absolute;
        top: 356px" Width="133px" TabIndex="2">
    </asp:DropDownList>
    <asp:DropDownList ID="DropDownList2" runat="server" Style="left: 403px; position: absolute;
        top: 432px" Width="122px" TabIndex="3">
    ...
    <asp:DropDownList ID="DropDownList3" runat="server" Style="left: 403px; position: absolute;
        top: 514px" Width="124px" TabIndex="5" DataSourceID="ObjectDataSource1" DataTextField="USER_NAME" DataValueField="USER_NAME">
    </asp:DropDownList>
    <br />
    <br />
    <br />
    ...
    <br />
    <br />
    <asp:Label ID="Label15" runat="server" Font-Bold="True" ForeColor="White" Style="left: 289px;
