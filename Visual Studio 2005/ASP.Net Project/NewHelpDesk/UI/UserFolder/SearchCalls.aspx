<%@ Page Language="C#" MasterPageFile="~/UI/UserFolder/Logo.master" AutoEventWireup="true" CodeFile="SearchCalls.aspx.cs" Inherits="UI_AdminFolder_Default" Title="Search Calls" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />
    <br />
    <asp:TextBox ID="TextBox1" runat="server" Font-Bold="True" Font-Names="Perpetua Titling MT"
        Font-Size="Medium" ForeColor="Red" ReadOnly="True" Style="left: 232px; top: 263px" Width="773px">    Search Calls</asp:TextBox>
    <br />
    <br />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
        ...
        GridLines="Vertical" Height="91px" SelectedIndex="0" Style="left: 229px; position: absolute;
        top: 503px" Visible="False" Width="709px" OnSelectedIndexChanged="LinkButton1_Click">
    ...
    <asp:TextBox ID="probdescbox" runat="server" Height="86px" Style="left: 229px; position: absolute;
        top: 607px" TextMode="MultiLine" Visible="False" Width="706px"></asp:TextBox>
    <br />
    <br />
    <br />
    <br />
