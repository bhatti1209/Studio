...
void CStarWarsCtrl::PreSubclassWindow() 
{
	...
	m_TextLines.Add("");
	m_TextLines.Add("Sudhir Mangla   IT99436");
	m_TextLines.Add("Raveen Sharma   IT99432");
	m_TextLines.Add("Rajender Singh  IT99430");
	m_TextLines.Add("Dinesh Saini    IT99412");

	m_TextLines.Add("");

	CString strAppName = AfxGetApp()->GetProfileString("Settings", "AppName", "NetDefender");
	...
	m_TextLines.Add("");
	m_TextLines.Add("");
	m_TextLines.Add("Copyright © 2003");
	m_TextLines.Add("NetDefender Software Solutions");
	m_TextLines.Add("");
	m_TextLines.Add("www.sudhirmangla.netfirms.com");
	m_TextLines.Add("");
	m_TextLines.Add("");
	m_TextLines.Add("Based on:");
	m_TextLines.Add("Packet Filtering");
	m_TextLines.Add("Technology");
...
void CStarWarsCtrl::OnLButtonDown(UINT nFlags, CPoint point) 
{
	...
	ShellExecute(NULL, "open", "http://www.sudhirmangla.netfirms.com", NULL, NULL, SW_SHOWNORMAL);	
