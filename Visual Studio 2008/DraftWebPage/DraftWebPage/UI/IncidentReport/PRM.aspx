<%@ Page Language="C#" MasterPageFile="~/UI/PageDesign.Master" AutoEventWireup="true" CodeBehind="PRM.aspx.cs" Inherits="DraftWebPage.UI.IncidentReport.PRM" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="DisplayData" runat="server">
    <div style="z-index: 1; left: 0px; top: 0px; position: absolute; height: 482px; width: 724px">
        ...
        <asp:Panel ID="Panel1" runat="server" runat="server" BackColor="#E0F2B5" 
